                            ...
                            @foreach($category->items as $item)
                                <div
                                    ...
                                    <div class="flex flex-col justify-between p-2 leading-normal ">
                                        ...
                                        {{--                                        add to list button--}}
                                        <a href="#"
                                           class="px-4 py-2 text-sm font-bold  border border-primary uppercase bg-white rounded-0  self-start hover:bg-primary hover:text-white">
                                            Add to list
                                        </a>
                                    </div>
                                </div>
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        @foreach($specialItems as $item)
            <div class="max-w-sm bg-white dark:bg-gray-800 dark:border-gray-700">
                <img class="rounded-none lozad h-64 w-full md:w-72 object-cover" data-src="{{ $item->photo_thumbnail_url }}" alt=""/>
                <div class="py-5">
                    <div class="flex items-center justify-between mb-2">
                    ...
                    <a href="#"
                       class="inline-flex items-center px-3 py-1 text-sm font-medium text-center uppercase text-gray-800 border rounded-none border-primary hover:text-primary focus:ring-2 focus:outline-none focus:ring-primary focus:ring-offset-2">
                       Add To List
