<footer {{ $attributes->class(['bg-gray-900 bg-center bg-no-repeat bg-cover']) }}
    ...
    <div class="text-center text-white text-sm border-t border-t-gray-700 bg-gray-900 py-4 tracking-wider">
        CopyRight &copy; {{ now()->year }} <a href="mailto:jeanpaulcami@live.com" class="text-primary">Jean Paul
            Byiringiro</a> All Rights Reserved | Created by <a
            href="tel:0780661813" class="text-primary">Jean Paul Byiringiro</a>
    </div>
</footer>
